          ...
          <div className="space-y-[100px]">
            ...
            <article className="texte_exhibition">
              <div className="grid md:grid-cols-2 gap-x-[100px] px-[100px] max-w-[1440px] mx-auto text-justify">
                <div>
                  <p className="mb-4">
                    <em>Madame Bovary, c'est vous.</em>
                  </p>
                ...
                <div>
                  ...
                  <p className="mt-6 text-xs text-muted-foreground">
                    *Bandes noires qui permettent de respecter le format d'affichage d'un film (4/3, 16/9), sans le déformer ou le recadrer. L'inverse du plein écran.
                  </p>
                </div>
              </div>
            </article>

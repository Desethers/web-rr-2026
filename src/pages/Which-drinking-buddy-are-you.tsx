...
import { whichDrinkingImages } from "../data/whichdrinkingimg";
...
const WhichDrinkingBuddyAreYou: React.FC = () => {
  const images = whichDrinkingImages;
    ...
    <>
      ...
      <main className="pt-20">
        ...
        <section className="textandinfos">
          <div className="containerintro max-w-[1440px] grid md:grid-cols-2 gap-6 max-w-5xl mx-auto px-6 lg:px-8 py-6">
            <div className="intro_exhibition">
              <p>28 avril - 20 mai 2018</p>
              <p className="mt-2">
                Chiffonnier,
                <br />
                75011, Paris
...
export default WhichDrinkingBuddyAreYou;

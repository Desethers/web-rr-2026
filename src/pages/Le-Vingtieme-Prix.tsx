...
const LeVingtiemePrix: React.FC = () => {
  ...
  const extraImages = images.filter(
    (img) =>
      img.src !== "/assets/vingtieme-prix/vingtieme-3.jpg" &&
      img.src !== "/assets/vingtieme-prix/vingtieme-4.jpg" &&
      img.src !== "/assets/vingtieme-prix/vingtieme-10.jpg"
  );
        ...
        <section className="textandinfos">
          <div className="containerintro grid md:grid-cols-2 gap-4 max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-[25px] py-4">
            ...
            <div className="intro_exhibition space-y-2 md:space-y-5 text-sm md:text-[18px] 2xl:text-2xl">
              <p>
                For the past twenty years, the Prix de la Fondation d'entreprise Ricard has asserted itself as a key force in shaping the French art scene—its structures, hierarchies, methods, and forms.
              </p>
              <p>
                Year after year, it legitimizes the practices of artists, curators, and institutions, while playfully subverting itself when it invites artists to act as curators and curators to engage in artistic practice.
              </p>
            </div>

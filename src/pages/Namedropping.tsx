          ...
          <div className="pt-6 sm:pt-10 md:pt-12 lg:pt-16 xl:pt-20 space-y-12 sm:space-y-16 md:space-y-20 lg:space-y-24 xl:space-y-[100px]">
            ...
            <article className="texte_exhibition">
              ...
              {isMobile && (
                ...
                >
                  <span className="font-medium">{isTextExpanded ? "Masquer le texte" : "Lire la suite"}</span>
                  <ChevronDown
                ...
                <figure className="imagefull" key={idx}>
                  ...
                  <div className="flex flex-col gap-2 mt-2">
                    ...
                    {img.inquireLink && (
                      <Link
                        to={img.inquireLink}
                        className="bouton_inquire block border border-foreground w-full py-2 text-center hover:bg-foreground hover:text-background transition-colors text-sm md:text-base"
                      >
                        Inquire
                      </Link>
                    )}
